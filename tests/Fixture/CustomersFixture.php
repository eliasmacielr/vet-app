...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'phone_other' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'customers_ibfk_1' => ['type' => 'foreign', 'columns' => ['location_id'], 'references' => ['locations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-05-17 15:44:16',
            'modified' => '2016-05-17 15:44:16',
            'location_id' => 1
        ],
    ];
}
