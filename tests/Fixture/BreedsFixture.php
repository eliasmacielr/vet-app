...
class BreedsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'name' => ['type' => 'unique', 'columns' => ['name', 'species_id'], 'length' => []],
            'breeds_ibfk_1' => ['type' => 'foreign', 'columns' => ['species_id'], 'references' => ['species', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'created' => '2016-05-20 03:41:53',
            'modified' => '2016-05-20 03:41:53',
            'species_id' => 1
        ],
    ];
}
