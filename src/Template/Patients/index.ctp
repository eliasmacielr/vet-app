                        ...
                        <tbody>
                            <?php foreach ($patients as $patient): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $this->Url->build(['action' => 'view', 'id' => $patient->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                                        <a href="<?= $this->Url->build(['action' => 'edit', 'id' => $patient->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
