<?php $this->assign('title-meta', 'Vet APP - Vacunas') ?>
                        ...
                        <tbody>
                            <?php foreach ($vaccines as $vaccine): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $this->Url->build(['action' => 'edit', 'id' => $vaccine->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
