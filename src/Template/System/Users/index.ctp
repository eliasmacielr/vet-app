...
<?php $this->assign('title-meta', 'Vet System - Usuarios') ?>
                        ...
                        <tbody>
                            <?php foreach ($users as $user): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?= $this->Url->build(['action' => 'edit', 'id' => $user->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                                        <?= $this->Form->create(null, ['url' => ['action' => 'delete', 'id' => $user->id], 'type' => 'delete', 'style' => 'display: inline !important']) ?>
