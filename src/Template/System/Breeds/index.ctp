...
<?php $this->assign('title-meta', 'Vet System - Razas') ?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('Species.name', 'Especie') ?></th>
                                <th>Acciones</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($breeds as $breed): ?>
                                <tr>
                                    <td><?= h($breed->name) ?></td>
                                    <td><?= h($breed->species->name) ?></td>
                                    <td>
                                        <a href="<?= $this->Url->build(['action' => 'edit', 'id' => $breed->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                                        <?= $this->Form->create(null, ['url' => ['action' => 'delete', 'id' => $breed->id], 'type' => 'delete', 'style' => 'display: inline !important']) ?>
