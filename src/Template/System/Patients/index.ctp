...
<?php $this->assign('title-meta', 'Vet System - Pacientes') ?>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('Customers.id', 'Cód. Prop.') ?></th>
                                <th><?= $this->Paginator->sort('Customers.name', 'Nombre Prop.') ?></th>
                                <th><?= $this->Paginator->sort('Customers.last_name', 'Apellido Prop.') ?></th>
                        ...
                        <tbody>
                            <?php foreach ($patients as $patient): ?>
                                <tr>
                                    ...
                                    <td><a href="<?= $this->Url->build(['controller' => 'Customers', 'action' => 'view', 'id' => $patient->customer->id]) ?>"><?= h($patient->customer->id) ?></a></td>
                                    <td><?= h($patient->customer->name) ?></td>
                                    <td><?= h($patient->customer->last_name) ?></td>
                                    <td><?= h($patient->breed->name) ?></td>
                                    <td>
                                        <a href="<?= $this->Url->build(['action' => 'view', 'id' => $patient->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Ver</a>
                                        <a href="<?= $this->Url->build(['action' => 'edit', 'id' => $patient->id]) ?>" class="btn btn-primary"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span> Editar</a>
                                        <?= $this->Form->create(null, ['url' => ['action' => 'delete', 'id' => $patient->id], 'type' => 'delete', 'style' => 'display: inline !important']) ?>
